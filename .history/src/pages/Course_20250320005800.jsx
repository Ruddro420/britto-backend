                                        ...
                                        <div className="row">
                                            <div className="col-lg-12 col-sm-12 col-md-12 mt-3">
                                                <div class="form-group">
                                                    ...
                                                    <select
                                                        ...
                                                        name="category" id="" className='form-control'>
                                            ...
                                            <div className="col-lg-6 col-sm-6 col-md-6 mt-3">
                                                <div class="form-group">
                                                    ...
                                                    <input name='intro_video' type="text" class="form-control" placeholder='Intro Video' />
                                                </div>
                                            </div>
                                            <div className="col-lg-3 col-sm-6 col-md-4 mt-3">
                                                <div class="form-group">
                                                    <label className='mb-2'>Video Count</label>
                                                    <input name='video_count' type="text" class="form-control" placeholder="Video Count" />
                                                </div>
                                            </div>
                                            <div className="col-lg-3 col-sm-6 col-md-4 mt-3">
                                                <div class="form-group">
                                                    <label className='mb-2'>Course Week</label>
                                                    <input name='course_week' type="text" class="form-control" placeholder="Course Week" />
                                                </div>
                                            </div>
                                            <div className="col-lg-3 col-sm-6 col-md-4 mt-3">
                                                <div class="form-group">
