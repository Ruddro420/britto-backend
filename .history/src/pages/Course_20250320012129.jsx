...
const Course = () => {
    const { getApiData ,addCourse} = useContext(DataContext);
    ...
    const submit = (e) => {
        ...
        addCourse(data); // Pass FormData to addCourse function
    };
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-lg-6 col-sm-6 col-md-6 mt-3">
                                                <div class="form-group">
                                                    ...
                                                    <input name='banner' onChange={handleChange} type="file" class="form-control" />
                                                </div>
                                            </div>
                                            <div className="col-lg-6 col-sm-6 col-md-6 mt-3">
                                                <div class="form-group">
