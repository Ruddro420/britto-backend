                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-lg-6 col-sm-12 col-md-6 mt-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="course_name" id="" className='form-control'>
                                            ...
                                            <div className="col-lg-12 col-sm-12 col-md-12 mt-3">
                                                <div class="form-group">
                                                    ...
                                                    <input name='module_name' type="text" class="form-control" placeholder="Module Name" />
                                                </div>
                                            </div>
                                            <div className="col-lg-12 col-sm-12 col-md-12 mt-3">
                                                <div class="form-group">
                                                    <label className='mb-2'>Module Topics *(use comma)*</label>
                                                    <textarea name='module_topics' class="form-control"  id=""></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div className="col-lg-6 col-sm-6 col-md-6 mt-3">
                                                <div class="form-group">
                                                    ...
                                                    <input name='module_video' type="text" class="form-control" placeholder='Module Video' />
                                                </div>
                                            </div>
                                            <div className="col-lg-12 col-sm-12 col-md-12 mt-3">
                                                <div class="form-group">
                                                    <label className='mb-2'>Module Descripton </label>
                                                    <textarea class="form-control" name="module_des" id=""></textarea>
                                                </div>
                                            </div>
                                            <div className="col-lg-6 col-sm-6 col-md-6 mt-3">
                                                <div class="form-group">
                                                    <label className='mb-2'>Extra One</label>
                                                    <input name='extra_one' type="text" class="form-control" placeholder="Extra One" />
                                                </div>
                                            </div>
                                            <div className="col-lg-6 col-sm-6 col-md-6 mt-3">
                                                <div class="form-group">
                                                    <label className='mb-2'>Extra Two</label>
                                                    <input name='extra_two' type="text" class="form-control" placeholder="Extra Two" />
                                                </div>
                                            </div>
                                        </div>
